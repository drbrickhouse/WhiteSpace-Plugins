<?php
/*
* Plugin Name: WhiteSpace Widgets
* Plugin Description: Provides all widgets for the WhiteSpace theme
* Version: 1.0
...
/************* PHP Code ***********************/
class WhiteSpace_PHP_Code extends WP_Widget {

	function whitespace_php_code() {
    ...
    $title = apply_filters( 'widget_title', $instance['title']);
		...
		require( 'whitespace_widgets_php_code_front_end.php' );
	}
    ...
    $title = esc_attr( $instance['title'] );
		...
		require( 'whitespace_widgets_php_code_fields.php' );
	}
}

/************* Logo ***********************/
class WhiteSpace_Logo extends WP_Widget {

	function whitespace_logo() {
		// Instantiate the parent object
    ...
    extract( $args );
		...
		require( 'whitespace_widgets_logo_front_end.php' );
	}
    ...
    $title = esc_attr( $instance['title'] );
		...
		require( 'whitespace_widgets_logo_fields.php' );
	}
}

/************* Bootstrap Menu ***********************/
class WhiteSpace_Bootstrap_Menu extends WP_Widget {

	function whitespace_bootstrap_menu() {
		// Instantiate the parent object
    ...
    $title = apply_filters( 'widget_title', $instance['title']);
		...
		require( 'whitespace_widgets_bootstrap_menu_front_end.php' );
	}
    ...
    $title = esc_attr( $instance['title'] );
		...
		require( 'whitespace_widgets_bootstrap_menu_fields.php' );
	}
}


/************* Bootstrap Menu Toggle ***********************/
class WhiteSpace_Bootstrap_Menu_Toggle extends WP_Widget {

	function whitespace_bootstrap_menu_toggle() {
		// Instantiate the parent object
    ...
    $title = apply_filters( 'widget_title', $instance['title']);
		...
		require( 'whitespace_widgets_bootstrap_menu_toggle_front_end.php' );
	}
    ...
    $title = esc_attr( $instance['title'] );
		...
		require( 'whitespace_widgets_bootstrap_menu_toggle_fields.php' );
	}
}

/************* Loop ***********************/
class WhiteSpace_Loop extends WP_Widget {

	function whitespace_loop() {
		// Instantiate the parent object
    ...
    $title = apply_filters( 'widget_title', $instance['title']);
		...
		require( 'whitespace_widgets_loop_front_end.php' );
	}
    ...
    $title = esc_attr( $instance['title'] );
		...
		require( 'whitespace_widgets_loop_fields.php' );
	}
}

/************* Single Post ***********************/
class WhiteSpace_Single_Post extends WP_Widget {

	function whitespace_single_post() {
		// Instantiate the parent object
    ...
    $title = apply_filters( 'widget_title', $instance['title']);
		...
		require( 'whitespace_widgets_single_post_front_end.php' );
	}
    ...
    $title = esc_attr( $instance['title'] );
		...
		require( 'whitespace_widgets_single_post_fields.php' );
	}
}
...
/*************** Hero Image ***************/
class WhiteSpace_Hero_Image extends WP_Widget {

	function whitespace_hero_image() {
		// Instantiate the parent object
    ...
    $title = apply_filters( 'widget_title', $instance['title']);
		...
		require( 'whitespace_widgets_hero_front_end.php' );
	}
    ...
    $title = esc_attr( $instance['title'] );
		...
		require( 'whitespace_widgets_hero_fields.php' );
	}
}

/************************ Twitter Widget **********************************/
class WhiteSpace_Twitter_Carousel extends WP_Widget {

	function whitespace_twitter_carousel() {
		// Instantiate the parent object
    ...
    $title = apply_filters( 'widget_title', $instance['title']);
		...
		require( 'whitespace_widgets_twitter_front_end.php' );
	}
    ...
    $title = esc_attr( $instance['title'] );
		...
		require( 'whitespace_widgets_twitter_fields.php' );
	}
}

/************* Related Content ***********************/
class WhiteSpace_Related_Content extends WP_Widget {

	function whitespace_related_content() {
		// Instantiate the parent object
    ...
    extract( $args );
		...
		require( 'whitespace_widgets_related_content_front_end.php' );
	}
    ...
    $title = esc_attr( $instance['title'] );
		...
		require( 'whitespace_widgets_related_content_fields.php' );
	}
}

/************************ Register Widgets Function ***********************/
function whitespace_register_widgets() {
	register_widget( 'WhiteSpace_PHP_Code' );
	register_widget( 'WhiteSpace_Logo' );
	register_widget( 'WhiteSpace_Bootstrap_Menu' );
	register_widget( 'WhiteSpace_Bootstrap_Menu_Toggle' );
	register_widget( 'WhiteSpace_Loop' );
	register_widget( 'WhiteSpace_Single_Post' );
	register_widget( 'WhiteSpace_CTAs' );
	register_widget( 'WhiteSpace_Hero_Image' );
	register_widget( 'WhiteSpace_Twitter_Carousel' );
	register_widget( 'WhiteSpace_Related_Content' );
}

/************ Hook Into Widgits Init to Register the Widgets ******************/
add_action( 'widgets_init', 'whitespace_register_widgets' );
